...
module "oidc_provider" {
  source = "github.com/Roro-yero/td5-2//td5/scripts/tofu/modules/github-aws-oidc"
...
module "iam_roles" {
  source = "github.com/Roro-yero/td5-2//td5/scripts/tofu/modules/gh-actions-iam-roles"
